...
Workings
I Use a list of dictionaries to store the books.
I Use loops and conditionals to implement the menu system.
I Use string manipulation to format the output.
I Use type casting to convert user input to appropriate data types.
I Use file handling to save and load the library.
